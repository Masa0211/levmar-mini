...
void test_ross()
{
    ...
    {
        double p[] = { -1.2, 1.0 };
        const double expected[] = { 0.9432308872, 0.889388354307 };
        int ret = dlevmar_der(ros, jacros, p, x, m, n, 1000, opts, info, NULL, NULL, NULL); // with analytic Jacobian
...
void test_osborne()
{
    ...
    {
        std::cout << "Osborne analytic Jacobian" << std::endl;
